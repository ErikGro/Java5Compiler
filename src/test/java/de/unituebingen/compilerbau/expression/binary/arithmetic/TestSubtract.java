...
public class TestSubtract extends CompilerTest {
    ...
    public Map<String, Clazz> getExpectedClassMap() {
        ...
        Block body2 = new Block(Arrays.asList(new Return(new Subtract(new IntLiteral(43), new IntLiteral(1)))));
    ...
    public void testAST() throws ASTException {
        ...
        assertEquals(getExpectedClassMap().get("MockSubtract"), resultMap.get("MockSubtract"));
    }
    ...
    public void testGeneratedBytecode() throws IOException, CloneNotSupportedException, ReflectiveOperationException {
        ...
        Class c = this.compiledClasses.get("MockSubtract");
