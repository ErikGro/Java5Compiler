...
public class TestPublicField extends CompilerTest {
    public String getMockFilePath() {
        return "/clazz/field/MockPublicField.java";
    }
    ...
    public void testAST() throws ASTException {
        ...
        assertEquals(getExpectedClassMap().get("MockPublicField"), resultMap.get("MockPublicField"));
    }
    ...
    public void testGeneratedBytecode() throws IOException, CloneNotSupportedException, ClassNotFoundException {
        ...
        Class c = this.compiledClasses.get("MockPublicField");
    }
}
