...
public class TestCharIntMismatch extends CompilerTest {
    @Override
    public String getMockFilePath() {
        return "/typeerrors/MockCharIntMismatch.java";
    }

    @Override
    public Map<String, Clazz> getExpectedClassMap() {
        Field testField = new Field(AccessModifier.PACKAGEPRIVATE, false, "test", new IntLiteral(42), Type.CHAR);
    ...
    public void testAST() throws ASTException {
        ...
        assertEquals(getExpectedClassMap().get("MockCharIntMismatch"), resultMap.get("MockCharIntMismatch"));
    }
